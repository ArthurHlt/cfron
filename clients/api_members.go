...
func (r ApiGetMemberRequest) Execute() ([]Member, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return []Member
 */
func (a *MembersApiService) GetMemberExecute(r ApiGetMemberRequest) ([]Member, *_nethttp.Response, GenericOpenAPIError) {
	var (
