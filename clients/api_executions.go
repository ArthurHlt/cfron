...
func (r ApiListExecutionsByJobRequest) Execute() ([]Execution, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return []Execution
 */
func (a *ExecutionsApiService) ListExecutionsByJobExecute(r ApiListExecutionsByJobRequest) ([]Execution, *_nethttp.Response, GenericOpenAPIError) {
	var (
